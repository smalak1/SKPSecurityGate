...
<script>
  $(function () {
    ...
    $('#example1').DataTable({
  	...
  	document.getElementById("divTitle").innerHTML="Internal Journals Transfers";
  ...
  {
	  window.location="?a=showInternalJournalRegister&firmId="+drpfirmId.value+"&txtfromdate="+txtfromdate.value+"&txttodate="+txttodate.value;
  ...
  function deleteTransfer(customerId)
  {
  	...
  	var xhttp = new XMLHttpRequest();
  	  ...
  	  xhttp.open("GET","?a=deleteJournalTransfer&transferId="+customerId, true);    
  	  xhttp.send();
  }
