		...
		<tbody>
			<c:forEach items="${ListStock}" var="item">
				...
				<td>${item.ware_house_name}</td>
								<td><a href="?a=showStockRegister&itemId=${item.item_id}&firmId=${item.firm_id}&txtfromdate=23/01/1992">${item.item_name}</a></td>
...
<script>
  ...
  {
	  window.location="?a=showStockStatusClubbed&categoryId="+drpcategoryId.value+"&firmId="+drpfirmId.value+"&warehouseid="+drpwarehouseId.value+"&searchString="+txtsearch.value;
  ...
  function exportStockStatusClubbedAsPDF()
  {
	  ...
	  window.open("?a=exportStockStatusClubbedAsPDF&categoryId="+drpcategoryId.value+"&firmId="+drpfirmId.value+"&warehouseid="+drpwarehouseId.value+"&searchString="+txtsearch.value);
