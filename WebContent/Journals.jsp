...
<div class="row">
              ...
              <div class="card-body table-responsive p-0" style="height: 580px;">                
				...
				<c:forEach items="${message}" var="item">
					<tr >
						<td><a href="?a=showJournalEntry&journal_id=${item.journal_id}"> ${item.journal_id}</a> </td>
						...
						<td></td><td><button class="btn btn-danger" onclick="deleteJournals(${item.journal_id})">Delete</button></td>
					</tr>
				</c:forEach>
...
<script>
  $(function () {
    ...
    $('#example1').DataTable({
  	...
  	document.getElementById("divTitle").innerHTML="Journals";
  ...
  {
	  window.location="?a=showJournals&type=${param.type}&firmId="+drpfirmId.value+"&txtfromdate="+txtfromdate.value+"&txttodate="+txttodate.value;
