...
function printLabels()
{
	 ...
	 var xhttp = new XMLHttpRequest();
	  ...
	  xhttp.open("POST", "?a=internalBankTransfer", true);
	  ...
	  //return;
	  xhttp.send("frombank="+drpfromaccount.value+"&tobank="+drptoaccount.value+"&amount="+txtamount.value+"&remarks="+remarks.value+"&fromfirm="+drpfromfirm.value+"&tofirm="+drptofirm.value+"&txtdate="+txtdate.value); 
...
<div class="col-sm-3">
      ...
      <select class='form-control' id="drpfromfirm" name = "drpfromfirm" class="form-control" onchange="getBanksForThisFirm(this.value,'drpfromaccount')">
  ...
  <div class="col-sm-3">
      ...
      <select class='form-control' id="drpfromaccount" name = "drpfromaccount" class="form-control" >
				<option value="-1">---------------Select ----------</option>
		</select>
  ...
  <div class="col-sm-3">
      ...
      <select class='form-control' id="drptofirm" name = "drptofirm" class="form-control" onchange="getBanksForThisFirm(this.value,'drptoaccount')">
				<option value="-1">---------------Select ----------</option>
				<c:forEach items="${listfirmData}" var="item">
				    <option value="${item.firmId}">${item.firmName}</option>			    
		   		</c:forEach>
  ...
  <div class="col-sm-3">
      ...
      <select class='form-control' id="drptoaccount" name = "drptoaccount" class="form-control" onchange="checkForSameBank()" >
				<option value="-1">---------------Select ----------</option>
...
<script>
		...
		document.getElementById("divTitle").innerHTML="Internal Transfer";
		
		$( "#txtinvoicedate" ).datepicker({ dateFormat: 'dd/mm/yy' });
		
		
		function checkForSameBank()
		{
			
			if(drpfromaccount.value==drptoaccount.value)
				{
					
					alert("from bank to bank cannot be same");
