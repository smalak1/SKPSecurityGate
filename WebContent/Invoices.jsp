              ...
              <div class="card-body table-responsive p-0" style="height: 580px;">                
				...
				<c:forEach items="${message}" var="item">
					<tr >
						...
						<td><a href="#" onclick="showInvoice(${item.invoice_id})">${item.invoice_id}</a></td>
...
<script>
  ...
  {
	  window.location="?a=showInvoices&type=${param.type}&firmId="+drpfirmId.value+"&txtfromdate="+txtfromdate.value+"&txttodate="+txttodate.value;
  ...
  function editInvoice(invoiceId)
  {
	  if('${param.type}'=='P')
		  {
	  		window.location="?a=showGeneratePI&editFlag=Y&invoiceId="+invoiceId;
		  }
	  else
		  {
		  	window.location="?a=showGenerateSI&editFlag=Y&invoiceId="+invoiceId;
		  }
  }
