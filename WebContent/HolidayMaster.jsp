...
function deleteHoliday(holidayId)
{
	...
	var xhttp = new XMLHttpRequest();
	  ...
	  xhttp.open("GET","?a=deleteHoliday&holidayId="+holidayId, true);    
	  xhttp.send();
}
...
<c:set var="message" value='${requestScope["outputObject"].get("ListOfHolidays")}' />
           ...
           <div class="card-header">    
                ...
                <div class="card-tools">
                  <div class="input-group input-group-sm" style="width: 200px;">                    
                    <input type="button"  class="btn btn-block btn-primary btn-sm" onclick="window.location='?a=showAddHoliday'" value="Add New Holiday" class="form-control float-right" >                      
                  </div>
                </div>
              ...
              <div class="card-body table-responsive p-0" style="height: 580px;">                
                <table id="example1"class="table table-head-fixed  table-bordered table-striped dataTable dtr-inline" role="grid" aria-describedby="example1_info">
                  <thead>
                    <tr>
                     ...
                     <th><b>Holiday ID</b></th>
                     <th><b>Holiday Name</b></th>
				...
				<c:forEach items="${message}" var="item">
					<tr >
						...
						<td><a href="?a=showAddHoliday&holidayId=${item.holiday_id}">Edit</a></td><td><button class="btn btn-danger" onclick="deleteHoliday(${item.holiday_id})">Delete</button></td>
					</tr>
				</c:forEach>
...
<script>
  ...
  document.getElementById("divTitle").innerHTML="Holiday Master";
